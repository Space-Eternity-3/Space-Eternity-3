...
This is the server for Space Eternity 3 separated from other game files, which works on `node.js`. This repository is the exact copy of the `./ServerReady` folder in the main Space Eternity 3 repository.
